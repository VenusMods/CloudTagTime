...
def get_sounds_directory(sound):
    user_home = os.path.expanduser("~/Library/Application Support/TagTime")
    if not os.path.exists(user_home):
        os.makedirs(user_home)
    path = os.path.join(user_home, f'sounds/{sound}')
    # NEEDED FOR PLAYSOUND TO FIND IT
...
class PromptWindow(customtkinter.CTkToplevel):
    def __init__(self, parent):
        ...
        # icon = ImageTk.PhotoImage(file=resource_path('img/tagtime.png'))
